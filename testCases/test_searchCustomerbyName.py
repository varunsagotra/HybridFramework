...
class Test_005_SearchCustomerByName:
    ...
    def test_SearchCustomerByEmail(self, setup):
        ...
        self.logger.info("*****[Test_Case_Id]____Test_005_Search____********")
        ...
        searchcust.setFirstName("Sowmya")
        searchcust.setLastName("Sri")
        searchcust.clickSearch()
        time.sleep(5)
        status = searchcust.searchCustomerByName("Sowmya Sri")
        assert True == status
